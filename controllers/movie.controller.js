...
// Example: const Movie = require('../models/movie');

// findAllMovies - to search the movie by status.
exports.findAllMovies = (req, res) => {
  // Implement your logic to find movies by status and send a JSON response
};

// findOne - to fetch all details of a movie given its id.
exports.findOne = (req, res) => {
  // Implement your logic to find a movie by id and send a JSON response
};

// findShows - to fetch details of shows of a specific movie given its id.
exports.findShows = (req, res) => {
  // Implement your logic to find shows for a specific movie and send a JSON response
};
